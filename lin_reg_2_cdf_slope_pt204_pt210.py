...
def linear_regression():
    ...
    width = 6
    height = 4.5
    plt.figure(3, figsize=(width * len(drugs), height * pt_amount))
    plt.figure(4, figsize=(width * len(drugs), height * pt_amount))
    ...
    for pt_s in range(len(pt_disks)):
        for pt in pt_disks[pt_s]:
            raw_path = pt_dict[pt]
            print(pt)
            plt.figure(2, figsize=(height * col_amount, height * len(drugs)))
            plt.clf()
...
################################################################33333333
                ...
                plt.xticks(fontsize=17)
                plt.yticks(fontsize=17)
                plt.xlim(0, viability_y_lim)
                plt.ylim(0, viability_y_lim)
                plt.xlabel("ImageJ", fontsize=17)
                plt.ylabel("CancerCellTracker", fontsize=17)
                ...
                for i in range(5):
                    ...
                    plt.title(drug + "(dose " + str(i + 1) + ")", fontsize=17)
